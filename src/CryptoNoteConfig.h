...
const uint64_t CRYPTONOTE_MAX_BLOCK_NUMBER                   = 40000000;
const size_t   CRYPTONOTE_MAX_BLOCK_BLOB_SIZE                = 40000000;
const size_t   CRYPTONOTE_MAX_TX_SIZE                        = 80000000;
...
const char     CRYPTONOTE_NAME[]                             = "Vortex Ventura";
